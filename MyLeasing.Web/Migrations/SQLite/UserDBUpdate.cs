...
public partial class UserDBUpdate : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            {
                Id = table.Column<string>("TEXT", nullable: false),
                Document = table.Column<string>("TEXT", maxLength: 20,
                    nullable: false),
                ...
                Address = table.Column<string>("TEXT", maxLength: 100,
                    nullable: true),
                FixedPhone = table.Column<string>("TEXT", nullable: true),
                CellPhone = table.Column<string>("TEXT", nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            table => new
            {
                ...
                LastName = table.Column<string>("TEXT", maxLength: 50,
                    nullable: false),
                ProfilePhotoUrl = table.Column<string>("TEXT", nullable: true),
                ProfilePhotoId = table.Column<Guid>("TEXT", nullable: false),
                FixedPhone = table.Column<string>("TEXT", nullable: true),
                CellPhone = table.Column<string>("TEXT", nullable: true),
                Address = table.Column<string>("TEXT", maxLength: 100,
